...
def create_parser():
    ...
    parser.add_argument(
        '--input', '-i', type=argparse.FileType('r',encoding='utf-8'), default=sys.stdin,
        metavar='PATH',
    ...
    parser.add_argument(
        '--output', '-o', type=argparse.FileType('w',encoding='utf-8'), default=sys.stdout,
        metavar='PATH',
...
if __name__ == '__main__':
    ...
    args = parser.parse_args(['-i','../quora_data/src_train.csv','-o','final.data','-c','bpe_train.data'])
